...
const worker = new Worker(new URL('../training/workers/qLearningSingle.worker.ts', import.meta.url), { type: 'module' });
...
worker.onmessage = (e: MessageEvent) => {
    ...
    switch (msg.type) {
        ...
        case 'brainData': {
            ...
            a.href = url;
            a.download = `q-learning-single-pendulum-ep${episode}.json`;
