...
const worker = new Worker(new URL('../training/workers/reinforceDouble.worker.ts', import.meta.url), { type: 'module' });
...
worker.onmessage = (e: MessageEvent) => {
    ...
    switch (msg.type) {
        ...
        case 'brainData': {
            ...
            a.href = url;
            a.download = `reinforce-double-pendulum-ep${episode}.json`;
